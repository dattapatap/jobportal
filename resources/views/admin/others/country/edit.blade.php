        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6 offset-3">
                    <form class="card" action="{{ route('admin.country.update', $country->id ) }}" method="POST" accept-charset="UTF-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{old('country_name', $country->name)}}" name="country_name"  placeholder="Country Name">
                                        @error('country_name')
