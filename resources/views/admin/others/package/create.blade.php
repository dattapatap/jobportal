        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6 offset-3">
                    <form class="card" action="{{ route('admin.packages.store')}}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('name') }}" name="name"  placeholder="Package Name">
                                        @error('name')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group pb-3">
                                        ...
                                        <input type="number" class="form-control" value="{{ old('amount') }}" name="amount"  placeholder="Package Amount">
                                        @error('amount')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
