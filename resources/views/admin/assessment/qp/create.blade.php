...
<div class="app-content">
    <div class="side-app" style="padding-top:6px;">
        <div class="page-header">
            <h4 class="page-title">Create Question Paper</h4>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12">                    
                    <form id="frmQP" class="card" action="{{ route('admin.qp.create') }}" method="POST">
                        @csrf
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control select2" name="qp_category" id="qp_category"  placeholder="select category" style="width:100%">
                                                ...
                                                @forelse ($category as $cat)
                                                    <option value="{{ $cat->id }}" @if( old('qp_category') == $cat->id ) selected @endif> {{ $cat->name }} </option>                                                
                                                @empty
                                    ...
                                    <div class="form-row col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="number" name="tot_questions" id="tot_questions" class="form-control" value="0" readonly>
                                                @error('tot_questions')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <ul class="questions">
                                            ...
                                            @forelse ($questions as $item)
                                                ...
                                                <label class="custom-control custom-checkbox filter {{ 'category_'.$item->category->id}}">
                                                    ...
                                                    @if(is_array(old('questions')) && in_array($item->id, old('questions'))) checked @endif >
