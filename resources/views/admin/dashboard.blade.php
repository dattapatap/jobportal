                ...
                <div class="card">
                    <div class="card-body text-center feature">
                        <div class="fa-stack fa-lg fa-1x icons shadow-default bg-primary-transparent">
                            <i class="icon fa fa-briefcase text-secondary"></i>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center feature">
                        <div class="fa-stack fa-lg fa-1x icons shadow-default bg-secondary-transparent">
                            <i class="icon fa fa-user text-secondary"></i>
                        </div>
                        <p class="card-text mt-3 mb-3">Total Employer Registered</p>
                        <p class="h2 text-center text-secondary">{{ $totRec }}</p>
                    </div>
                </div>
            </div><!-- COL END -->
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body text-center feature ">
                        ...
                        <p class="h2 text-center text-success-1">{{ $totEmp}}</p>
                    </div>
                </div>
            </div><!-- COL END -->
                                    ...
                                    @forelse ($postedJobs as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a  href="{{ url('admin/jobs/view/' . $item->id) }}"  class="btn btn-primary btn-sm text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                    <tr>
