...
<div class="app-content">
    <div class="side-app">
        ...
        <div class="m-0">
            <a href="{{ url('admin/postedjobs')}}" class="btn btn-info btn-md pr-5"> <i class="fa fa-arrow-left ml-1 pr-2"></i> Back </a>
        </div>
        <br>
        <div class="row">
            <div class="col-md-12">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="">
                                                <ul class="mb-2" style="font-size: 15px;">
                                                    <li class="mr-3 mt-2"><a  href="{{ url('admin/recruiter/view/'.$jobs->recruiter->id )}}" class="icons"><i class="si si-factory text-muted mr-1"></i> {{ $jobs->recruiter->company_name }} </a></li>
                                                    <li class="mr-3 mt-2"><a  class="icons"><i class="si si-briefcase text-muted mr-1"></i> {{ $jobs->job_industry }} </a></li>
                                                    <li class="mr-3 mt-2"><a  class="icons"><i class="si si-location-pin text-muted mr-1"></i> {{ $jobs->job_location }}</a></li>
                                                    <li class="mr-4 mt-2"><a  class="icons"><i class="fa fa-inr text-muted mr-3"></i>{{ $jobs->min_salary.' - '.$jobs->max_salary }} </a></li>
                                                    <li class="mr-4 mt-2"><a  class="icons"><i class="fa fa-clock-o text-muted mr-3"></i>{{ $jobs->job_type }} </a></li>
                                                    <li class="mr-3 mt-2"><a  class="icons"><i class="si si-calendar text-muted mr-1"></i> {{ $jobs->created_at->diffForHumans() }}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
