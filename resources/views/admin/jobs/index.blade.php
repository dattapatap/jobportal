                                                ...
                                                <div class="card overflow-hidden  border-0 box-shadow-0 border-left br-0 mb-0">
                                                    <div class="card-body pt-0 pt-md-5">
                                                        <div class="item-card9">
                                                            <a href="{{ url('admin/jobs/view/'.$job->id)}}" class="text-dark"><h4 class="font-weight-semibold mt-1">{{ $job->job_title}}</h4></a>
                                                            <div class="mt-2 mb-2">
                                                    ...
                                                    <div class="card-footer pt-3 pb-3">
                                                        <div class="item-card9-footer d-flex">
                                                            <div class="d-flex align-items-center mb-3 mb-md-0 mt-auto posted">
                                                                <div>
                                                                    <a href="profile.html" class="text-muted fs-12 mb-1">Posted by </a><span class="ml-1 fs-13"> {{ $job->recruiter->company_name }} </span>
                                                                    <small class="d-block text-default">{{ $job->created_at->diffForHumans()}} </small>
                                                                </div>
                                                            </div>
                                                            <div class="ml-auto">
                                                                <a href="{{ url('admin/recruiter/view/'.$job->recruiter->id )}}" class="mr-3"><i class="fa fa-user text-muted mr-1"></i>{{ $job->recruiter->company_name }}</a>
                                                                <a href="{{ url('admin/jobs/view/'.$job->id)}}" class="btn btn-primary mt-3 mt-sm-0"> View </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
