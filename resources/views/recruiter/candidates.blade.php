                        ...
                        <div class=" item2-gl">
                            <div class=" mb-0">
                                <div class="">
                                    ...
                                    <form id="empSearch" action="{{ url('recruiter/employee/search') }}" method="GET"
                                        class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="positions" id="positions" class="form-control select2"
                                                    ...
                                                    @foreach ($positions as $item)
                                                        <option value="{{ $item->id }}" @if ($arrPositions == $item->id) selected="selected" @endif>
                                                            {{ $item->name }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card overflow-hidden br-0 overflow-hidden">
                                                ...
                                                <div class="item-card9  mt-md-1">
                                                    ...
                                                    <div class="mt-1">
                                                        <a class="text-dark">
                                                            <h6 class="font-weight-semibold mt-1"><span>Exp Salary :
                                                    ...
                                                    @endphp
                                                    <div class="mt-1"><span>Category : @php echo $categoryType @endphp
                                                        </span> </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body table-responsive border-top">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-4 text-center">
                                                            <button class="btn btn-default mt-1 mb-1"
                                                        ...
                                                        <div class="col-md-4">
                                                            @if (isset($intrest))
                                                                @if (in_array($item->id, $intrest))
                                                                    <button class="btn btn-default mt-1 mb-1 float-right"
                                                                        disabled> <i class="fa fa-check" style="color: blue"></i>&nbsp;
                                                                        Interested</button>
                                                                @else
                                                                    <button
                                                                        class="btn btn-default mt-1 mb-1 float-right showInterest"
                                                                        id="{{ $item->id }}">Show Interest</button>
                                                                @endif
                                                            @else
                                                                <button
                                                                    class="btn btn-default mt-1 mb-1 float-right showInterest"
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    <h4 class="page-title text-danger">No Candidate found, please try with
                                                        another key</h4>
                                                </div>
                                            </div>
